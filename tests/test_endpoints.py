...
def test_status_code_planet_endpoint(client, mocker):
    mocker.patch('src.services.Search.search_planet', return_value=list_planets)
...
def test_invalid_planet(client, mocker):
    ...
    mocker.patch('src.services.Search.search_planet', side_effect=PlanetNotFound)
...
def test_return_planet_alderaan(client, mocker):
    mocker.patch('src.services.Search.search_planet', return_value=list_alderaan)
