...
from src.domain import APINotFoundData, PlanetNotFound

from .api_test_data import list_alderaan, list_hoth, list_planets, list_yavin


def test_status_code_planet_endpoint(client, mocker):
    mocker.patch('src.main.Search.search_planet', return_value=list_planets)
